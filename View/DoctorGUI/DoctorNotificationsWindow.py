...
class DoctorNotificationsWindow(QWidget):
    """
    Doctor Notifications Window
    """
    ...
    def _createTopBar(self):
        ...
        self.prescriptionOption = Designer.createMenuOption(
            self.topCard, "Prescribe", "../ImageResources/Icon5BGRemoved.png", 160
        )
